...
export function TaysirDashboardIcon({
	className,
	size = 24,
	style,
}: IconProps) {
...
export function GraduationIcon({ className, size = 24, style }: IconProps) {
	return (
		...
		>
			...
			/>
			<path
				d="M6 12v5c0 1.1.9 2 2 2h8a2 2 0 002-2v-5"
				stroke="currentColor"
				strokeWidth="1.5"
				strokeLinecap="round"
				strokeLinejoin="round"
...
export function BuildingIcon({ className, size = 24, style }: IconProps) {
	return (
		...
		>
			...
			/>
			<path
				d="M8 6h2M8 10h2M8 14h2M14 6h2M14 10h2M14 14h2"
				stroke="currentColor"
				strokeWidth="1"
				opacity="0.2"
			/>
...
export function PhoneIcon({ className, size = 24, style }: IconProps) {
	return (
		...
		>
			<path
				d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.79 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.9.339 1.85.573 2.81.7A2 2 0 0122 16.92z"
				stroke="currentColor"
				strokeWidth="1.5"
			/>
		</svg>
