...
export const LogoMark = ({ size = 28, color = "var(--brand-500)" }: { size?: number; color?: string }) => (
...
export const Logo = ({ color = "var(--brand-500)", textColor }: { color?: string; textColor?: string }) => (
