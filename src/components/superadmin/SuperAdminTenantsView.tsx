						...
						t.id === selectedTenant.id
							? {
									...
									contractEndDate: res.data.contractEndDate
										? new Date(res.data.contractEndDate)
										: null,
								}
							: t,
					),
		...
		<div className="space-y-10 pb-20">
						...
						<div className="p-8 flex flex-col flex-1">
							<div className="flex items-start justify-between mb-8">
								<div
									className={clsx(
										...
										tenant.isActive
											? "bg-surface-50 text-brand-500 border-line"
							...
							<div className="mb-8">
								<div className="flex items-center gap-2 mb-2">
									<h3 className="text-2xl font-bold text-ink-900 line-clamp-1 tracking-tight">
										{tenant.name}
									</h3>
									{!tenant.isActive && (
										<span className="text-[10px] font-bold text-danger bg-rose-50 border border-rose-100 px-2 py-0.5 rounded-full uppercase tracking-wider">
											Suspendu
										</span>
									)}
								</div>
								...
								<span
									className={clsx(
										...
										tenant.contractEndDate &&
											new Date(tenant.contractEndDate) < new Date()
											? "text-danger"
											: "text-ink-700",
									)}
								>
			...
			>
				<form
					...
					className="space-y-8 max-h-[80vh] overflow-y-auto px-1 custom-scrollbar pb-6"
				>
						...
						<div className="space-y-4">
							...
							<div className="space-y-1">
								...
								<p className="text-[10px] text-ink-400 font-medium px-1">
									Cet identifiant servira à créer l'adresse d'accès :{" "}
									<span className="text-brand-500 font-bold">
										{formSlug || "votre-ecole"}.taysir.dz
									</span>
								</p>
							</div>
							<Input
							...
							<div className="space-y-3">
								...
								<div className="flex items-center gap-6 p-4 bg-surface-50 rounded-xl border border-line">
									...
									/>
									<span className="text-xs font-medium text-ink-500 leading-relaxed">
										Cette couleur sera utilisée comme accent principal sur le
										dashboard du client.
									</span>
								</div>
							</div>
						...
						<div className="space-y-4">
							...
							<div className="p-4 bg-brand-50 border border-brand-500/20 rounded-xl">
								<p className="text-xs font-semibold text-brand-900 leading-relaxed">
									Ce compte aura les pleins pouvoirs (GERANT) sur l'instance
									créée. Communiquez ces identifiants au client après le
									déploiement.
								</p>
							</div>
						</div>
					...
					<Input
						...
						defaultValue={
							selectedTenant?.contractEndDate
								? new Date(selectedTenant.contractEndDate)
										.toISOString()
										.split("T")[0]
								: ""
						}
