import { Calendar, ArrowUpRight, Plus, MapPin } from 'lucide-react';
      ...
      <div>
        <div className="flex justify-between items-start mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-black text-sm uppercase tracking-tighter block leading-none text-taysir-teal">Planning</span>
              <span className="text-[10px] font-bold text-taysir-teal/40 uppercase tracking-widest mt-1 block">Activité en temps réel</span>
            </div>
          </div>
        ...
        <div className="mt-4">
          ...
          <h3 className="text-lg font-bold text-taysir-teal/80 uppercase tracking-tighter">Séances programmées</h3>
