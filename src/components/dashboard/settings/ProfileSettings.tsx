...
import { updateProfileAction, deleteAccountAction } from "@/actions/settings.actions";
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        <form onSubmit={handleUpdateProfile} className="p-6 sm:p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
            <Input name="firstName" label={t("first_name")} defaultValue={user.firstName} placeholder={t("placeholder_first_name")} required />
            <Input name="lastName" label={t("last_name")} defaultValue={user.lastName} placeholder={t("placeholder_last_name")} required />
            <Input name="email" label={t("email")} defaultValue={user.email} type="email" placeholder={t("placeholder_email")} required />
            <Input name="phone" label={t("phone")} defaultValue={user.phone} placeholder={t("placeholder_phone")} />
          </div>
